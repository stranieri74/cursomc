...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				.useDefaultResponseMessages(false) //desabilita as respostas padrão
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.nelioalves.cursomc.recources"))
	...
	//mensagem quando realizar  uma inserção
