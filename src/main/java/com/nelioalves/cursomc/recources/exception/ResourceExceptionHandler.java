package com.nelioalves.cursomc.recources.exception;
...
public ResponseEntity<StandardError> DateIntegrity(DateIntegrityException e,
...
public ResponseEntity<StandardError> ValidationMethodArgumentNotValidException(MethodArgumentNotValidException e,
		HttpServletRequest request){
